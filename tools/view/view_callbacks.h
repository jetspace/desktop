...
gboolean show_about(GtkWidget *w, GdkEvent *e, gpointer p)
{
    ...
    gtk_about_dialog_set_program_name(GTK_ABOUT_DIALOG(dialog), "SIDE Picture Viewer");
...
{
    GtkWidget *dialog = gtk_file_chooser_dialog_new("Open File", GTK_WINDOW(win), GTK_FILE_CHOOSER_ACTION_OPEN, "Cancel", GTK_RESPONSE_CANCEL, "Open", GTK_RESPONSE_ACCEPT, NULL);
